// FactoringOperation.h
#ifndef LOGIC_SYSTEM_FACTORING_OPERATION_H
#define LOGIC_SYSTEM_FACTORING_OPERATION_H
...
{
    class FactoringOperation : public Operation
    {
    public:
        FactoringOperation(
            ...
            : upper_node_(upper_node), lower_node_(lower_node), previous_lit_(previous_lit), previous_substitution_(previous_substitution), applied_mgu_(applied_mgu) {}
...
#endif // LOGIC_SYSTEM_FACTORING_OPERATION_H